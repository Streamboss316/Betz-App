  ...
  return (
    <div className="min-h-screen bg-background pt-20 pb-8">
      <header className="fixed top-0 left-0 right-0 z-50 bg-black/90 backdrop-blur-xl border-b border-primary/20 h-16 flex items-center px-6">
        ...
        <div className="ml-4">
          <h1 className="text-lg font-bold" data-testid="revenue-title">Revenue & Withdrawals</h1>
          <p className="text-xs text-muted-foreground -mt-0.5">Platform earnings and payouts</p>
        </div>
      </header>
