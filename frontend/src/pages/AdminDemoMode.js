  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center gap-4">
        ...
        <p className="text-sm text-muted-foreground">Loading demo users...</p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-background pt-20 pb-8">
      <header className="fixed top-0 left-0 right-0 z-50 bg-black/90 backdrop-blur-xl border-b border-primary/20 h-16 flex items-center px-6">
        ...
        <div className="ml-4">
          <h1 className="text-lg font-bold" data-testid="demo-mode-title">Demo Mode</h1>
          <p className="text-xs text-muted-foreground -mt-0.5">Test as any user account</p>
        </div>
      </header>
