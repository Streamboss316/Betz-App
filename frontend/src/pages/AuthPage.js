...
export default function AuthPage({ onLogin }) {
  ...
  return (
    ...
    >
      {/* Racing Header Background - Drag Racing Burnout Image */}
      <div className="absolute top-0 left-0 right-0 h-[450px] overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-background/70 to-background z-10"></div>
        <img 
          src="https://images.unsplash.com/photo-1552167065-f9d57ffdeb9a?w=1600&q=80"
