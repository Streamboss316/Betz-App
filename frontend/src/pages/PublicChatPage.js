  ...
  return (
    <div className="min-h-screen bg-background pt-16 pb-24 flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-5" data-testid="chat-messages">
        ...
        {/* Message Input */}
        <div className="border-t border-white/10 p-4 pb-24 bg-card/50 backdrop-blur-sm">
          <div className="flex gap-3 max-w-4xl mx-auto">
            <Input
              ...
              className="flex-1 bg-muted/30 border-white/10 rounded-full h-11"
              data-testid="message-input"
            />
            <Button
              onClick={handleSendMessage}
              disabled={!newMessage.trim()}
              className="btn-premium text-white rounded-full h-11 px-6"
