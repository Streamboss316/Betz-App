...
export default function GlobalHeader({ user, onLogout, onShowQR, onShowTutorial }) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 glass-card h-16 flex items-center justify-between px-6">
      ...
      <div className="flex items-center gap-2">
        ...
        {/* Profile Avatar */}
        <Avatar 
          className="h-9 w-9 cursor-pointer border-2 border-primary/50 hover:border-primary transition-all" 
